...
function PreOrder() {
    ...
    const handleIncrement = (productId) => {
        setQuantities(prevQuantities => {
            ...
            const currentQuantity = prevQuantities[productId] || 0; // Start from 0 if not already set
    ...
    const handleDecrement = (productId) => {
        setQuantities(prevQuantities => {
            ...
            return {
                ...prevQuantities,
                [productId]: newQuantity >= product.Min_Order_QTY__c ? newQuantity : 0 // Hide if quantity falls below min
            };
        });
    };
